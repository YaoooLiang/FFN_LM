...
parser.add_argument('--resume', type=str, default='/home/xiaotx/2017EXBB/model/ffn_model_fov:51_delta:15_depth:12_recall.pth', help='resume training')
...
parser.add_argument('--stream', type=str, default="adam_4_Gpu", help='job_stream')
...
def run():
    ...
    while cnt < args.iter:
        ...
        if best_loss > loss.item() or t_curr - t_last > args.interval:
            ...
            print('Precision: {:.2f}%, Recall: {:.2f}%, Accuracy: {:.2f}%, Model saved!'.format(precision * 100, recall * 100, accuracy * 100))
        """
